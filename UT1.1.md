...
A pesar de contar con un procesador de textos (Bravo), un sistema de correo electrónico (Hardy), un programa de dibujo vectorial y un editor de mapas de bits, amigable con el usuario, y estaba lejos de poder ser utilizado en una empresa.
...
Apple y su Mac OS X, lanzarían posteriormente también alrededor de 18 versiones, la más reciente es Big Sur lanzada a mediados del 2020.
